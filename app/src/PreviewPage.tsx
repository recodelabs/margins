...
const PREVIEW_INITIAL_MARKDOWN = [
  ...
  "",
  "JSON blocks render pretty-printed, and hovering a code block shows a Copy button:",
  "",
  "```json",
  '{"resourceType":"Group","id":"example-household","type":"person","actual":true,"quantity":6}',
  "```",
  "",
  "---",
  "comments:",
